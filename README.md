# Mahmud Shamim | Full-Stack Developer & UI/UX Designer

Welcome to my portfolio website built with **Next.js**, **Framer Motion**, and **Tailwind CSS**. This repository contains my projects, experience, and a dynamic CV builder.

## �� Tech Stack

- **Frontend:** React, Next.js, Framer Motion, Matter.js
- **Backend:** Node.js, Next.js API Routes, MongoDB (Resend for email)
